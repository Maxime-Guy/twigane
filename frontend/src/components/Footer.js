        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/whatsapp" className="footer-link">WhatsApp Chat</Link></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/chat" className="footer-link">Cultural Tips</Link></li>
              <li><Link to="/chat" className="footer-link">Practice Exercises</Link></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            ...
            <div className="footer-bottom-links">
              <Link to="/contact" className="footer-bottom-link">Privacy</Link>
              <Link to="/contact" className="footer-bottom-link">Terms</Link>
              <Link to="/contact" className="footer-bottom-link">Cookies</Link>
